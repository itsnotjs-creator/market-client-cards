...
export default function SiteHeader() {
  ...
  const isAuthenticated = status === SESSION_STATUS.AUTHENTICATED && Boolean(session?.user);
    ...
    <>
      <div className="top-bar">
        <div className="page-shell top-bar__inner">
          <span className="top-bar__tagline">Distribuyendo soluciones desde 1981</span>
      ...
      <header className="site-header">
        <div className="page-shell site-header__inner">
          ...
          <div className="site-header__search">
            <input type="text" placeholder="Buscar por código, producto, marca, vehículo..." />
            <select>
          ...
          <div className="site-header__actions">
            {isAuthenticated ? (
              <>
                <Link href="/perfil" className="site-header__btn site-header__btn--outline">
              ...
              <>
                <Link href="/extranet-vendedor" className="site-header__btn site-header__btn--outline">
                  <PersonOutlinedIcon fontSize="small" />
                  <div>
                    <span className="site-header__btn-label">Extranet Vendedor</span>
                    <strong>Acceso vendedores</strong>
                  </div>
                </Link>
                <Link href="/login" className="site-header__btn site-header__btn--primary">
                  <ShoppingCartOutlinedIcon fontSize="small" />
                  <div>
                    <span className="site-header__btn-label">Acceso Clientes</span>
